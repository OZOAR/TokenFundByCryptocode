<div class="login-form popup hidden">
  ...
  <div class="login-form-wrapper sign-in">
    ...
    <div class="error-message hidden"><p>Please enter valid data</p></div>
    <form id="signInForm">
    ...
    <div class="additional-links">
      ...
      <div class="new-user">
        <span>@lang('index.auth.form.sign_in.new_user') <a href="#" id="switchToSignUp">@lang('index.auth.form.sign_up.sign_up')</a></span>
      </div>
    </div>
  </div>
  <div class="login-form-wrapper sign-up hidden">
    <h2>@lang('index.auth.form.sign_up.sign_up')</h2>
    <div class="error-message hidden"><p>Email already exist</p></div>
    ...
    <div class="success-message hidden"><p>Thanks for joining. We will connect with you!</p></div>
    <div class="additional-links">
      <div class="new-user">
        <span>@lang('index.auth.form.sign_up.existing_user') <a href="#" id="switchToSignIn">@lang('index.auth.form.sign_in.sign_in')</a></span>
      </div>
    </div>
  </div>
</div>
